...
import { InstructorSelfController } from './controllers/instructor-self.controller';
...
} from './schemas/instructor-transactions.schema';
...
@Module({
  ...
  controllers: [InstructorsController, InstructorSelfController],
